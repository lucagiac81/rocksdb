...
static std::shared_ptr<ROCKSDB_NAMESPACE::Compressor> FLAGS_wal_compressor;
...
// Current the following isn't equivalent to OS_LINUX.
 ...
 private:
  ...
  void InitializeOptionsFromFlags(Options* opts) {
    ...
    options.wal_compressor = FLAGS_wal_compressor;
#ifndef ROCKSDB_LITE
...
int db_bench_tool(int argc, char** argv) {
  ...
  FLAGS_wal_compressor = StringToCompressor(FLAGS_wal_compression.c_str());
